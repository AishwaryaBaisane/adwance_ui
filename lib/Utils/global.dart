          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text('Platform Convertor ',style: TextStyle(fontWeight: FontWeight.w700,fontSize: 25),),
                  Obx(
                        () => Switch(
                      // onFocusChange: v,
                      value: data.value,
              ...
              buildCupertinoTextField(
                  icon: Icons.person, hintText: 'Full Name', context: context),
              buildCupertinoTextField(
              ...
              CupertinoButton(
                ...
                onPressed: () {
                  ...
                  chatController.insertRecord(
                      d1, d2, d3, chatController.ImgPath!.value.path, time, time2);
    ...
    return Scaffold(
      body: Obx(
            ...
            itemBuilder: (context, index) => ListTile(
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: chatController.DataList[index]['Phone']
                                    .toString(),
                                labelStyle: const TextStyle(),
                              ),
                            ),
                ...
                title: Text(chatController.DataList[index]['Name'].toString()),
                subtitle: Text(chatController.DataList[index]['Chat'].toString()),
                // subtitle: InkWell(
                //     onTap: () {
                //       chatController.removeRecords(
                //         int.parse(
